...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(com.dbll.NewCrossOriginResourceSharingFilter.class);
        resources.add(com.dbll.service.MarquesFacadeREST.class);
        resources.add(com.dbll.service.VoituresFacadeREST.class);
